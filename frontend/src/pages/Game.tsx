...
export function Game() {
  ...
  }, [current, guess, hintsUsed, result, roundHints, roundIndex]);
          ...
          <div className="hud-result-card">
            <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
              ...
              <div className="min-h-0 overflow-y-auto rounded-md border border-[var(--line)] bg-[var(--bg-inset)] p-4">
                ...
                {completedRoundPreview.length > 0 && (
                  <SummaryMap
                    className="mt-4 h-64 overflow-hidden rounded-md border border-[var(--line)] bg-[var(--bg-inset)]"
                    compact
                    fitPadding={36}
                    interactive={false}
                    rounds={completedRoundPreview}
